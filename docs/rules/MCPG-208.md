# MCPG-208 — Invisible or obfuscated content in resource metadata
...
Zero-width characters, bidi overrides, and HTML comments in a resource's `name` or `description`.
