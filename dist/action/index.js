...
var StdioServerDefSchema = z2.object({
  command: z2.string(),
  args: z2.array(z2.string()).optional(),
  env: z2.record(z2.string(), z2.string()).optional()
});
var HttpServerDefSchema = z2.object({
  type: z2.literal("http").optional(),
  url: z2.string(),
  headers: z2.record(z2.string(), z2.string()).optional()
});
var McpServerDefSchema = z2.union([StdioServerDefSchema, HttpServerDefSchema]);
var McpConfigFileSchema = z2.object({
  mcpServers: z2.record(z2.string(), McpServerDefSchema).optional()
});
